...
public class ExempleDUtilisation {
    ...
    public static void main(String[] args) {
        //On crée notre bandeau 
        Bandeau monBandeau = new Bandeau();
        
        //On crée un scénario 
        Scenario monScenario = new Scenario(monBandeau);

        //On ajoute des effets au scénario 
        monScenario.ajoutEffet(new Zoom(2, monBandeau, "On zoome"));
        monScenario.ajoutEffet(new ColorChange(1, monBandeau, "Changement de couleur"));
        monScenario.ajoutEffet(new Tourne(1, monBandeau, "On tourne !!"));
